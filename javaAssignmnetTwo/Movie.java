...
public class Movie implements Media {
		    ...
		    public Movie(String title, String d, int price, List<String> categories, String issn, int pages) {
		        this.title = title;
		        this.director = d;
		...
		//constructor
		    public Movie(String title, String author, double price) {
		        this.title = title;
		    ...
		    public void displayMovieInfo() {
		        ...
		        System.out.println(ANSI_GREEN + "=> Author: " + director + ANSI_RESET);
		        if (metadata != null) {
