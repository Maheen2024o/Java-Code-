...
public class AudioBook implements Media{
    ...
    public AudioBook(String title, String author, int price, List<String> categories, String issn, int duration) {
        this.title = title;
        this.author = author;
        this.metadata = new Metadata(price, categories, issn, duration);
    }

	 // Constructor to initialize the price of the magazine
	 public AudioBook(double price) {
	     this.price = price;
	 }
	 ...
	 public String toString() {
	     ...
	     return "=> Audio Book with price: " + this.price + ANSI_CYAN;
	 }
	//constructor
    ...
    public void displayAudioBookInfo() {
        ...
        if (metadata != null) {
            ...
            System.out.println(ANSI_CYAN + "=> Duration: " + metadata.getDuration() + ANSI_RESET);
        } else {
